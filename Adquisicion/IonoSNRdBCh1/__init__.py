...
#parent="/home/soporte/Isaac/Prueba"
...
#plt.axis([1.5969975,15,0,777])
#
#plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=10,vmax=26)#fc=10MHz
...
if((22<=hour0) or (hour0<=11)): #5pm-6am Debe ser correlacionado con el crontab #IPP=20ms    
    plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=0,vmax=12)#IPP=10ms
else:
    plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=0,vmax=15)#IPP=10ms
...
#plt.savefig("/home/soporte/Isaac/AdquIonoSDR/Ionogramas/Canal1/SNR/Iono-"+str("%02d" %month)+"-"+str("%02d" %day)+"-"+str(year)+"-"+str("%02d" %hour0)+":"+str("%02d" %minute)+":"+str("%02d" %second)+"UTC"+".png") #2 canales 10MHz rev
plt.savefig("/home/soporte/Isaac/AdquIonoSDR/Ionogramas/Canal1/SNR/HYEJM"+"_"+str(year)+str(dj)+str("%02d" %hour0)+str("%02d" %minute)+str("%02d" %second)+"_SNR"+".png") #2 canales 10MHz rev
#lt.savefig("/home/soporte/Isaac/Prueba/IonoSNR.png")
#plt.savefig("/home/soporte/Isaac/Prueba/fig.png") ##### 1 canales 20MHz
#plt.show()
