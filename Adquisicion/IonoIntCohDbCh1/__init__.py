...
#SDR implementado en GNU Radio Companion de manera autonoma para el canal 1. 
...
#Obs:
#Ch1: Extraordinary (perpendicular)  
...
parent="/home/soporte/Isaac/AdquIonoSDR/DataAlmacenada/DataCanal1" ###2canales 10MHZ

#parent="/home/soporte/Isaac/PruebaData1"
...
#plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=42,vmax=58)#fc=5MHz
#plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=38,vmax=56)#fc=10MHz
...
if(hour0==22): #[5pm-6am] Debe ser correlacionado con el crontab  IPP=20ms  
    #plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=30,vmax=40)#fc=5MHz
    plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=0,vmax=41)#IPP=10ms
elif(hour0==23):
    plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=0,vmax=43)#IPP=10ms
elif(16<=hour0<=21):
    plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=0,vmax=45)#IPP=10ms
elif(14<=hour0<=15):
    plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=0,vmax=40)#IPP=10ms 
else:
    #plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=30,vmax=40)#fc=10MHz IPP=20ms
    plt.pcolormesh(EjesXMHz,EjesY,Ploteo,vmin=0,vmax=43)#IPP=10ms
...
#plt.savefig("/home/soporte/Isaac/AdquIonoSDR/Ionogramas/Canal1/DB/Iono-"+str("%02d" %month)+"-"+str("%02d" %day)+"-"+str(year)+"-"+str("%02d" %hour0)+":"+str("%02d" %minute)+":"+str("%02d" %second)+"UTC"+".png") #2 canales 10MHz rev
plt.savefig("/home/soporte/Isaac/AdquIonoSDR/Ionogramas/Canal1/DB/HYEJM"+"_"+str(year)+str(dj)+str("%02d" %hour0)+str("%02d" %minute)+str("%02d" %second)+"_PWR"+".png") #2 canales 10MHz rev
#plt.savefig("/home/soporte/Isaac/Pruebas/Ionograma/10_01_2023/canal1/IonoDb.png")
#plt.savefig("/home/soporte/Isaac/ComparCabl/RG58/Db.png") ##### 1 canales 20MHz
#plt.show()
