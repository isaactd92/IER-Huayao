...
class Prueb_2canales_3MHz(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Prueb_2canales_3MHz")
        ...
        self.freq_centr = freq_centr = 3e6
...
def main(top_block_cls=Prueb_2canales_3MHz, options=None):
