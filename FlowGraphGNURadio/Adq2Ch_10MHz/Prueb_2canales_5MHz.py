...
class Prueb_2canales_5MHz(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Prueb_2canales_5MHz")
        ...
        self.connect((self.blocks_throttle_0_0_0, 0), (self.qtgui_time_sink_x_1_2, 0))
...
def snipfcn_snippet_2_0_1_0_0_0(self):
    ...
    #date_time = datetime(year, month, dayN, (hour-5), (minute+1), 4) # Se resta 5h para ponerlo en hora local (gps), se suma 1seg porque el crontab fue corrido un seg antes
    date_time = datetime(year, month, dayN, (hour-5), (minute+1), 5)
...
def main(top_block_cls=Prueb_2canales_5MHz, options=None):
