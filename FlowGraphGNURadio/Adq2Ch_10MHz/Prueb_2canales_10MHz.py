...
class Prueb_2canales_10MHz(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Prueb_2canales_10MHz")
        ...
        self.freq_centr_2 = freq_centr_2 = 7e6
        self.freq_centr = freq_centr = 10e6
        ...
        self.uhd_usrp_source_0.set_center_freq(freq_centr_2, 0)
        ...
        self.gr_digital_rf_digital_rf_channel_sink_0 = gr_digital_rf.digital_rf_channel_sink(
            ...
            metadata={"samp_rate":samp_rate,"bandwidth":samp_rate,"decimation":decimation,"storFreq":freq_almac,"filterTaps":filter_taps,"centerFreq":freq_centr_2,"Latitud":Latitud,"Lat_ind":Lat_ind,"Longitud":Longitud,"Long_ind":Long_ind},
            is_continuous=True,
            compression_level=8,
            checksum=False,
            marching_periods=True,
        ...
        self.Generator_ROJ_Generator_ROJ_0_0 = Generator_ROJ.Generator_ROJ(samp_rate, 'Seno', 500e-3, '/home/soporte/Isaac/ProgrDemo/all_freq_list_10ms.txt', freq_centr, 0, 20)
        self.Generator_ROJ_Generator_ROJ_0 = Generator_ROJ.Generator_ROJ(samp_rate, 'Seno', 500e-3, '/home/soporte/Isaac/ProgrDemo/all_freq_list_10ms.txt', freq_centr_2, 0, 20)
        ...
        self.connect((self.Generator_ROJ_Generator_ROJ_0_0, 0), (self.blocks_throttle_0_0_0_0, 0))
        ...
        self.connect((self.blocks_throttle_0_0_0_0, 0), (self.blocks_multiply_xx_0_0_0_0, 1))
    ...
    def get_freq_centr_2(self):
        return self.freq_centr_2

    def set_freq_centr_2(self, freq_centr_2):
        self.freq_centr_2 = freq_centr_2
        self.uhd_usrp_source_0.set_center_freq(self.freq_centr_2, 0)
...
def main(top_block_cls=Prueb_2canales_10MHz, options=None):
