...
class Prueb_2canales_6MHz(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Prueb_2canales_6MHz")
        ...
        self.freq_centr_2 = freq_centr_2 = 8e6
        self.freq_centr = freq_centr = 7e6
        ...
        self.uhd_usrp_source_0.set_center_freq(freq_centr_2, 1)
        ...
        self.Generator_ROJ_Generator_ROJ_0_0 = Generator_ROJ.Generator_ROJ(samp_rate, 'Seno', 500e-3, '/home/soporte/Isaac/ProgrDemo/all_freq_list_10ms.txt', freq_centr_2, 0, 20)
    ...
    def set_freq_centr_2(self, freq_centr_2):
        ...
        self.uhd_usrp_source_0.set_center_freq(self.freq_centr_2, 1)
...
def main(top_block_cls=Prueb_2canales_6MHz, options=None):
